...
class HotelPageInfo extends StatelessWidget {
  final index;

  HotelPageInfo({@required this.index});

  @override
  Widget build(BuildContext context) {
    return Consumer<BrainApp>(
      builder: (context, appBrain, child) {
        final listInfo = appBrain.infoHotelScreen[index];
        final listModal = appBrain.listModelHotelScreen[index];
        return Scaffold(
          appBar: AppBar(
            title: Text(
              listModal.title,
